...
yum install -y php54-php-pecl-zip php55-php-pecl-zip php56-php-pecl-zip php70-php-pecl-zip php71-php-pecl-zip php72-php-pecl-zip php73-php-pecl-zip php74-php-pecl-zip php81-php-pecl-zip php81-php-pecl-zip
...
echo "extension=ssh2.so" >> /etc/opt/remi/php81/php.ini
...
sed -i 's/user = apache/user = www-data/' /etc/opt/remi/php81/php-fpm.d/www.conf
sed -i 's/group = apache/group = www-data/' /etc/opt/remi/php81/php-fpm.d/www.conf
